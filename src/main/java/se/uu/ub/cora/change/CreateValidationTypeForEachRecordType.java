...
//
// public void createValidationTypes() {
// ClientDataList listOfRecordTypes = dataClient.readList(RECORD_TYPE);
//
// for (ClientData recordtypeData : listOfRecordTypes.getDataList()) {
// ClientDataRecord recordTypeRecord = (ClientDataRecord) recordtypeData;
// if (validRecordTypes(recordTypeRecord)) {
// ClientDataRecordGroup recordTypeRecordGroup = recordTypeRecord.getDataRecordGroup();
// if (isImplementingType(recordTypeRecordGroup)) {
// System.out.println("Convert: " + recordTypeRecordGroup.getId());
// createValidationTypeAndUpdateRecordType(recordTypeRecord,
// recordTypeRecordGroup);
// } else {
// System.out.println("Skip: " + recordTypeRecordGroup.getId() + " is abstract.");
// }
...
// }
//
// private boolean validRecordTypes(ClientDataRecord recordTypeRecord) {
// return !recordTypeRecord.getId().equals("systemSecret");
// }
//
// private void createValidationTypeAndUpdateRecordType(ClientDataRecord recordTypeRecord,
// ClientDataRecordGroup recordTypeRecordGroup) {
// Optional<String> createdRecordId = createValidationType(recordTypeRecordGroup);
//
// if (createdRecordId.isPresent()) {
// ClientDataRecordGroup topLevelParent = readTopParentRecord(recordTypeRecordGroup);
//
// updateRecordTypeWithTheNewValidationType(topLevelParent, createdRecordId);
// }
// }
//
// private void updateRecordTypeWithTheNewValidationType(
// ClientDataRecordGroup recordTypeRecordGroup, Optional<String> createdRecordId) {
// ClientDataRecordLink link = createLink(VALIDATION_TYPE, VALIDATION_TYPE,
// createdRecordId.get());
// repeatId++;
// link.setRepeatId(String.valueOf(repeatId));
// recordTypeRecordGroup.addChild(link);
// System.out.println("Update record type");
// dataClient.update(RECORD_TYPE, recordTypeRecordGroup.getId(), recordTypeRecordGroup);
// }
//
// private Optional<String> createValidationType(ClientDataRecordGroup recordTypeRecordGroup) {
// if (validateTypeDoesNotExist(recordTypeRecordGroup)) {
//
// ClientDataRecordGroup validationType = createValidationTypeRecordGroup(
// recordTypeRecordGroup);
// ClientDataRecord createdRecord = dataClient.create(VALIDATION_TYPE, validationType);
// return Optional.of(createdRecord.getId());
// } else {
// System.out.println("ValidationType already exists... ");
// }
...
// private boolean validateTypeDoesNotExist(ClientDataRecordGroup recordTypeRecordGroup) {
// try {
// dataClient.read(VALIDATION_TYPE, recordTypeRecordGroup.getId());
// return false;
// } catch (CoraClientException e) {
// return true;
// }
...
// ClientDataRecordGroup readRecordTypeRecordGroup) {
// ClientDataRecordGroup dataRecordGroup = ClientDataProvider
// .createRecordGroupUsingNameInData(VALIDATION_TYPE);
//
// ClientDataGroup readRecordInfo = (ClientDataGroup) readRecordTypeRecordGroup
// .getFirstChildWithNameInData(RECORD_INFO);
// ClientDataGroup recordInfo = ClientDataProvider.createGroupUsingNameInData(RECORD_INFO);
...
// }
//
// private ClientDataRecordGroup readTopParentRecord(ClientDataRecordGroup recordTypeRecordGroup) {
// if (recordTypeRecordGroup.containsChildWithNameInData("parentId")) {
// return readTopParentRecord(readParentLink(recordTypeRecordGroup));
// }
// System.out.println("Validates recordType: " + recordTypeRecordGroup.getId());
// return recordTypeRecordGroup;
// }
//
// private ClientDataRecordGroup readParentLink(ClientDataRecordGroup recordTypeRecordGroup) {
// ClientDataRecordLink parentLink = (ClientDataRecordLink) recordTypeRecordGroup
