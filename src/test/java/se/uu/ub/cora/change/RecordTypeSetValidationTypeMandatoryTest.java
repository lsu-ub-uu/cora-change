...
public class RecordTypeSetValidationTypeMandatoryTest {

	private RecordTypeSetValidationTypeMandatory updater;
	...
	public void testListRecordTypes_SystemOne_Utv() throws Exception {
		updater = new RecordTypeSetValidationTypeMandatory(SYSTEMONE_UTV_APPTOKEN_URL,
	...
	public void testListRecordTypes_Alvin_Utv() throws Exception {
		updater = new RecordTypeSetValidationTypeMandatory(ALVIN_UTV_APPTOKEN_URL,
				ALVIN_UTV_BASE_URL);
		updater.updateAllRecordInfosForAllGroupForAllRecordTypes();
	}
	...
	public void testListRecordTypes_Diva_Utv() throws Exception {
		updater = new RecordTypeSetValidationTypeMandatory(DIVA_UTV_APPTOKEN_URL,
				DIVA_UTV_BASE_URL);
		updater.updateAllRecordInfosForAllGroupForAllRecordTypes();
	}
	...
	public void testListRecordTypes_SystemOne_Dev() throws Exception {
		updater = new RecordTypeSetValidationTypeMandatory(SYSTEMONE_DEV_APPTOKEN_URL,
	...
	public void testListRecordTypes_Alvin_Dev() throws Exception {
		updater = new RecordTypeSetValidationTypeMandatory(ALVIN_DEV_APPTOKEN_URL,
				ALVIN_DEV_BASE_URL);
		updater.updateAllRecordInfosForAllGroupForAllRecordTypes();
	}
	...
	public void testListRecordTypes_Diva_Dev() throws Exception {
		updater = new RecordTypeSetValidationTypeMandatory(DIVA_DEV_APPTOKEN_URL,
				DIVA_DEV_BASE_URL);
		updater.updateAllRecordInfosForAllGroupForAllRecordTypes();
	}
}
